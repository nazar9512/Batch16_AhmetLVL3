...
public class BankCustomerPage {
    ...
    public void loginFunctionality(String name, String expHeader) throws InterruptedException {
    ...
    public void transactionsFunctionality() throws InterruptedException {
        Thread.sleep(1000);
        int actualBalance = Integer.parseInt(BrowserUtils.getText(balanceAmount));
        ...
        backBtn.click();
        Thread.sleep(1000);
        Assert.assertEquals(remainBalance, actualBalance);
